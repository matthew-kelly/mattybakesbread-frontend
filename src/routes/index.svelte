...
<div>
  ...
  <p class="font-semibold text-center md:text-left md:text-xl mb-8 md:mb-7">
  ...
  >
    ...
    <div class="card">
      ...
      <p>
        Find out if I've posted another poorly lit picture of a loaf of bread to my Instagram
        account.
      </p>
